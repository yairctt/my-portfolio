...
function ToggleTheme({ switchTheme }) {
    return (
        <div className="hs-tooltip [--placement:bottom] inline-block">
            <button onClick={switchTheme} className="hs-tooltip-toggle flex items-center text-2xl text-zinc-500 dark:text-zinc-300 hover:text-zinc-700 dark:hover:text-zinc-100 transition-all duration-300" aria-label="Dark Mode Button">
                <CgDarkMode />
